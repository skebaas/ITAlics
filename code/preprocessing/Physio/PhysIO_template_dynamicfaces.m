...
physio.log_files.scan_timing = {'dynamicfaces.dcm'};
...
physio.scan_timing.sqpar.Nscans = 504;
...
physio.model.output_multiple_regressors = 'multiple_regressors_dynamicfaces.txt';
physio.model.output_physio = 'physio_dynamicfaces.mat';
...
physio.verbose.fig_output_file = 'output_dynface.jpg'
