...
physio.log_files.scan_timing = {'efnback2.dcm'};
...
physio.model.output_multiple_regressors = 'multiple_regressors_efnback2.txt';
physio.model.output_physio = 'physio_efnback2.mat';
...
physio.verbose.fig_output_file = 'output_efnback2.jpg'
