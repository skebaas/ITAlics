...
"""
    ...
    if multiecho:  # instantiate relevant interfaces, imports
        ...
        #Changed by AS on 11.9.2021 to include custom_utils script
        from fmriprep.workflows.bold.custom_utils import init_skullstrip_bold_wf
    ...
    if not multiecho:
        ...
        workflow.connect([
            ### AS -10/8/2021- updated to remove skullstripping before tedana
            (inputnode, func_derivatives_wf, [
